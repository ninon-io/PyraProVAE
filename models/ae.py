...
class RegressionAE(nn.Module):
    ...
    def __init__(self, ae_model, latent_dims, regression_dims, recons_loss, regressor=None, regressor_name='',
                 **kwargs):
...
class DisentanglingAE(RegressionAE):
    ...
    def __init__(self, ae_model, latent_dims, regression_dims, recons_loss, regressor=None, regressor_name='',
                 disentangling=None, semantic_dim=-1, **kwargs):
        super(DisentanglingAE, self).__init__(ae_model, latent_dims, regression_dims, recons_loss, regressor,
                                              regressor_name)
        # Disentangling model
    ...
    def train_epoch(self, loader, loss_params, optimizer, args):
        ...
        for (x, y, meta, _) in loader:
            # Send to device
            x, y, meta = x.to(args.device, non_blocking=True), y.to(args.device, non_blocking=True), meta.to(

...
class Learn:
    ...
    def test_random(self, data_set, nb_test):
    ...
    def save(self, model_weights_saving_path, entire_model_saving_path, epoch):
        ...
        torch.save({'epoch': epoch,
                    ...
                    'loss': self.loss_mean},
                   entire_model_saving_path + '_epoch_' + str(epoch) + '.pth')
    ...
    def resume_training(self, entire_model_saving_path):
        model = self.model
        ...
        self.loss_mean = checkpoint['loss']
        model.eval()
